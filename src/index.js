...
function setChoices(roma, choices) {
  ...
  const indexedWords = words.map((word, id) => {
...
function setRoma(roma, choices, romaNode) {
...
function scoring() {
  document.getElementById('score').innerText = problemCount - errorCount;
  document.getElementById('count').innerText = problemCount;
}
